...
class LLMClientHF:
    ...
    def __post_init__(self):
        ...
        # If GPU available, let accelerate shard automatically
        ...
        # IMPORTANT: do NOT pass `device` here when model has hf_device_map
    ...
    # llm_client_hf.py – PATCH di method ask()
